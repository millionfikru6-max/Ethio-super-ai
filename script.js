...
function switchWorkspace(workspace) {
  ...
  const titles = {
    ...
    "ai-voice": "AI Voice Generator",
    "ai-video": "AI Video Generator",
    "ai-translator": "AI Translator",
    "ai-code": "AI Code Assistant",
    "ai-pdf": "AI PDF Assistant",
    "ai-resume": "AI Resume Builder",
    "ai-presentation": "AI Presentation Generator",
    "ai-email": "AI Email Writer",
...
function sendChatMessage() {
  ...
  conversationHistory.push({ sender: "user", message: message, timestamp: new Date() });
  chatInput.value = "";
  ...
  setTimeout(() => {
    ...
    conversationHistory.push({ sender: "ai", message: randomResponse, timestamp: new Date() });
...
function copyMessage(btn) {
  const messageText = btn.closest(".message-content").querySelector("p").textContent;
...
function regenerateResponse(btn) {
  ...
  messageContent.innerHTML = '<p>Regenerating response...</p>';
  ...
  setTimeout(() => {
    ...
    messageContent.innerHTML = `<p>${newResponse}</p>
      <div class="message-actions">
        <button class="action-btn" onclick="copyMessage(this)" title="Copy">📋</button>
        <button class="action-btn" onclick="regenerateResponse(this)" title="Regenerate">🔄</button>
      </div>
